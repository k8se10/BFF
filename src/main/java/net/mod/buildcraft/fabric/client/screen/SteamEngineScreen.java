...
public class SteamEngineScreen extends GlassHandledScreen<net.mod.buildcraft.fabric.screen.SteamEngineScreenHandler> {
    public SteamEngineScreen(net.mod.buildcraft.fabric.screen.SteamEngineScreenHandler h, PlayerInventory inv, Text t){ super(handler, inventory, title, "steamengine"); this.backgroundWidth=176; this.backgroundHeight=90; }
