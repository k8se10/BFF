...
import net.mod.buildcraft.fabric.screen.TableScreenHandler;

public class TableScreen extends GlassHandledScreen<TableScreenHandler> {
    public TableScreen(TableScreenHandler handler, PlayerInventory inv, Text title) {
        super(handler, inventory, title, "table");
    ...
    protected void drawBackground(DrawContext ctx, float delta, int mouseX, int mouseY) {
        ...
        var tex = net.mod.buildcraft.fabric.client.util.Assets.gui("assembly_table.png");
